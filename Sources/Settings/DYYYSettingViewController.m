...
- (void)setupSettingItems {
    self.settingSections = @[
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"保存到本地目录" key:DYYY_SAVE_TO_SANDBOX_KEY type:DYYYSettingItemTypeSwitch],
...
- (void)setupFooterLabel {
    ...
    self.footerLabel.text = [NSString stringWithFormat:@"Developer By @组长\nVersion: %@ (%@)", DYYY_VERSION, @"260923"];
